...
const POLICIES = [
  {
    ...
    sections: [
      ...
      ['Your rights', 'You can view and edit your profile and pet records at any time from your account. You can export a machine-readable copy of your data and you can delete your account, which removes your personal data and uploaded documents subject to records we are legally required to retain. Depending on where you live you may have additional rights — including access, correction, deletion, portability, and the right to object to or restrict certain processing — under the GDPR, the CCPA/CPRA, or another state privacy law. [OWNER + COUNSEL: confirm which regimes apply to this business and complete the response-time commitments.]'],
